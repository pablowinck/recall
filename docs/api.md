...
| DELETE | `/v1/decks/:id?cards=delete` or `?cards=move&target=<deck>` | Delete a deck after deleting its cards or moving them; 404 for a deck you do not own, 422 for your only deck |
